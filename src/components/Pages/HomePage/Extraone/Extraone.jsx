  ...
  return (
    <div>
      ...
      <div  className="bg-slate-400 md:w-[1100px] h-[500px] mb-[12rem] w-full md:mx-auto mx-3 relative">
        <h1 data-aos="fade-right" className="text-center hover:-translate-y-2 hover:translate-x-3 duration-500 text-5xl font-bold pt-10">Today&apos;s letest <span className="text-yellow-500">Sale</span></h1>
