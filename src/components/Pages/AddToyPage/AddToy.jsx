...
const AddToy = () => {
  ...
  return (
    <div className="mx-8 md:mx-auto my-3 w-full md:my-10 md:w-[1280px]">
      ...
      >
        {/* input boxes here */}
        <h1 className="text-5xl text-slate-800 font-bold md:my-10">Add a Toy</h1>
        ...
        <input className="px-4 bg-red-500 text-white hover:bg-slate-800 hover:text-white duration-500 font-semibold text-sm py-2 rounded shadow-xl hover:shadow-inner hover:shadow-slate-500  my-3" type="submit" value="Add a Toy" />
      </form>
    </div>
  );
};
